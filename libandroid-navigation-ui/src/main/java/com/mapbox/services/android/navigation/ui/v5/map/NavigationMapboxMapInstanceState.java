...
public class NavigationMapboxMapInstanceState implements Parcelable {
  ...
  protected NavigationMapboxMapInstanceState(Parcel in) {
  ...
  public static final Creator<NavigationMapboxMapInstanceState> CREATOR = new Creator<NavigationMapboxMapInstanceState>() {
    @Override
